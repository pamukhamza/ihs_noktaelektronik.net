...
const Footer = () => {
  return (
    <footer className="mt-10 bg-gradient-to-r from-black to-gray-700">
      <div className="mx-auto w-full max-w-screen-xl  container">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold  text-white uppercase ">Ürünler</h2>
            <ul className="text-white text-sm">
              <li className="mb-4"><a href="#" className=" hover:underline">Pasif Network Ürünleri</a></li>
              <li className="mb-4"><a href="#" className=" hover:underline">Aktif Network Ürünleri</a></li>
              <li className="mb-4"><a href="#" className=" hover:underline">CCTV Çözümleri</a></li>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold  uppercase text-white">Destek</h2>
            <ul className="text-white text-sm">
              <li className="mb-4"><a href="#" className="hover:underline">Teknik Destek Programı</a></li>
              <li className="mb-4"><a href="#" className="hover:underline">Arge & Üretim</a></li>
              <li className="mb-4"><a href="#" className="hover:underline">Yazılım</a></li>
              <li className="mb-4"><a href="#" className="hover:underline">Hakkımızda</a></li>
              <li className="mb-4"><a href="#" className="hover:underline">İletişim</a></li>
            </ul>
          </div>
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase text-white">Bİze Ulaşın</h2>
            <ul className=" text-white text-sm">
              <li className="mb-4">Perpa Ticaret Merkezi A Blok</li>
              <li className="mb-4">Kat:2 No:1 P.K. 34384</li>
              <li className="mb-4">Şişli/İstanbul</li>
              <li className="mb-4">Tel:<a href="tel:02122228780" className="hover:underline"> 0212 222 87 80</a></li>
              <li className="mb-4">E-Posta: <a href="mailto:nokta@noktaelektronik.net" className="hover:underline">nokta@noktaelektronik.net</a></li>
            </ul>
          </div>
          <div>
            <h2 className="mb-6 text-sm font-semibold  uppercase text-white">E-Bülten</h2>
        ...
        <div className="px-4 py-6 md:flex md:items-center md:justify-between border-t borderone">
          <span className="text-sm text-white sm:text-center">© 2024 <a href="https://www.noktaelektronik.net/">Nokta Elektronik</a>. Tüm hakları saklıdır.</span>
