...
const categorizedAddresses = {
  "Satış Mağazaları": [
    { title: "İstanbul Satış Mağazası 1", address: "Perpa Ticaret Merkezi B Blok Kat 8 No. 906-907 34384 Şişli / İstanbul" },
    { title: "İstanbul Satış Mağazası 2", address: "Perpa Ticaret Merkezi A Blok Kat 8 No.841 34384 Şişli / İstanbul"},
    { title: "Ankara Satış Mağazası 2", address: "Timko İş Yerleri Sitesi Timko Sk. E Blok No.4 06200 Yenimahalle / Ankara"},
  ],
  "Ofisler": [
    { title: "Genel Merkez", address: "Perpa Ticaret Merkezi A Blok Kat 2 No.1 34384 Şişli / İstanbul" },
    { title: "Ankara Bölge Ofisi", address: "Timko İş Yerleri Sitesi Timko Sk. E Blok No.4 06200 Yenimahalle / Ankara" },
  ],
  "Teknik Servisler": [
    { title: "Teknik Servis", address: "Perpa Ticaret Merkezi B Blok Kat 8 No. 906-907 34384 Şişli / İstanbul" },
  ],
  "AR-GE ve Fabrika": [
    { title: "Fabrika", address: "Organize Sanayi Bölgesi 5. Cadde No: 45, 41400 Kocaeli" },
    { title: "AR-GE Merkezi", address: "Teknokent 2. Bölge No: 33, 06800 Ankara" },
  ],
}
