...
const solutions = [
  { id: 1, nameKey: "solutions.cctv", icon: "⚡", link: "urunler/cctv-cozumleri-0" },
  { id: 2, nameKey: "solutions.fireAlarms", icon: "🔥", link: "urunler/yangin-algilama-sistemleri-0"  },
  { id: 3, nameKey: "solutions.hemsirecagri", icon: "🏥", link: "urunler/hemsire-cagri-sistemleri-0"  },
  { id: 4, nameKey: "solutions.sistemsaat", icon: "⌚", link: "urunler/merkezi-saat-sistemleri-0"  },
  { id: 5, nameKey: "solutions.bariyerotopark", icon: "🅿️", link: "urunler/bariyer-ve-otopark-cozumleri-0"  },
  { id: 6, nameKey: "solutions.customSoftware", icon: "💻", link: "software"  },
  { id: 7, nameKey: "solutions.mobileApps", icon: "📱", link: "software"  },
  { id: 8, nameKey: "solutions.cloudSolutions", icon: "☁️", link: "software"  },
  { id: 9, nameKey: "solutions.aiIntegration", icon: "🤖", link: "software"  },
]
